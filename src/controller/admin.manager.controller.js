...
const managerController = (req, res) => {
    res.status(200).send({ message: "Hello Manager!" });
};
...
const assignRequest = (req, res) => {
    res.status(200).send({ message: "API Assign Request!" });
};
...
const addInventory = (req, res) => {
    res.status(200).send({ message: "API Add Inventory!" });
};

const updateInventory = (req, res) => {
    res.status(200).send({ message: "API Update Inventory!" });
};

const deleteInventory = (req, res) => {
    res.status(200).send({ message: "API Delete Inventory!" });
};
